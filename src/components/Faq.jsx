  ...
  return (
    <>
      <div className="flex flex-col bg-black items-center">
        ...
        <p className="mt-3 textLg text-neutral-500 md:text-xl">
          Frequenty asked questions
        </p>
      </div>
      <div className="relative flex bg-black w-full  px-6 pt-10 pb-8  shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:maxW-2xl sm:roundedLg sm:px-10">
        <div className="mx-auto w-1/2 px-5">
          <div className="mx-auto mt-8 grid maxW-xl divide-y divide-neutral-200">
            <div className="py-5">
              <details className="group">
                <summary className="flex cursor-pointer list-none items-center justify-between font-medium">
                  <span>
                    What Services does your website Designing Agency offers
                  </span>
                ...
                <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                  We offer a comprehensive range of website design and
                  development services, including custom website design,
                  responsive design, content management systems (CMS), and
                  website maintenance.
                </p>
              </details>
            </div>
            ...
            <div className="py-5">
              <details className="group">
                ...
                <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                  ...
                  questions, you can contact the companys support team by
            ...
            <div className="py-5">
              <details className="group">
                ...
                <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                  ...
                  can sign up for the companys newsletter or follow it on social
                  media.
                </p>
              </details>
            </div>
